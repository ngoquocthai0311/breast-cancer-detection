...
def train_and_test_proposed_model(x_train, x_test, y_train, y_test, epochs = 5, verbose = 2):
...
def train_and_test_pretrained_vgg16_model(x_train, x_test, y_train, y_test, epochs = 5, verbose = 2, transfer_learning = False):
...
def train_and_test_pretrained_vgg19_model(x_train, x_test, y_train, y_test, epochs = 5, verbose = 2, transfer_learning = False):
...
def train_and_test_alexnet_model(x_train, x_test, y_train, y_test, epochs = 5, verbose = 2):
